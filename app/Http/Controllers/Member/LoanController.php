...
class LoanController extends Controller
{
    ...
    public function index()
    {
        ...
        $Loans = User::with(['loans.loanStatus', 'loans.verifiedBy','loans.paymentMethod'])->find(1)->loans;
        return response()->json(['data' => $Loans]);
    }

    public function show($loanId)
    {
        $Loan = Loan::with(['loanStatus', 'verifiedBy', 'paymentMethod'])->find($loanId);
        if (!$Loan) {
    ...
    function store(LoanRequest $LoanRequest)
    {
        ...
        $this->Loans->initial_payment_due_date = $validated['payment_date'];
    ...
    public function update(LoanRequest $LoanRequest, $loanId)
    {
        ...
        $Loan->initial_payment_due_date = $validated['payment_date'];
